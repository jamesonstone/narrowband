...
1. Month-End Close Reconciliation Workspace
   ...
   Description: Finance teams reconcile close data across Excel, ERP exports, emails, and manual review queues.

   Why: Highest score; recurring monthly pain, clear CFO/controller buyer, audit value, and strong willingness to pay.

2. Rehab Therapy Documentation and Authorization Queue

   Score: 8.0

   Description: PT/OT clinics juggle notes, payer authorization, visit limits, productivity, and delayed billing.

   Why: High-frequency clinical operations pain with measurable unpaid-care, billing, and clinician time impact.

3. Logistics Invoice, POD, and Exception Reconciliation

   Score: 8.0

   Description: Logistics teams match shipments, PODs, invoices, rate sheets, deductions, and customer exceptions manually.
